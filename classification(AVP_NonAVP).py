...
def build_model():
    ...
    inputs_3 = Input(shape=(2453, 1))

    bert_tf = TFBertModel.from_pretrained('../bert-base-uncased')

    for l in bert_tf.layers:
        l.trainable = True
    x_1 = bert_tf(inputs_1, attention_mask=inputs_mask)[0]
    ...
    max_pooling1d_2 = layers.AvgPool1D(pool_size=2, name='max_pooling1d_2')(conv1d_2)
